...
storiesOf('Components/Collection', module)
  ...
  . addWithJSX('link list', () => (
    <Collection isLinks header={text('header', '')}>
      <CollectionItem isActive={boolean('isActive', false)}>
        Alvin
      </CollectionItem>
      <CollectionItem>Simon</CollectionItem>
      <CollectionItem>Theodore</CollectionItem>
    </Collection>
  ))
  . addWithJSX('Secondary Content', () => (
    <Collection isLinks header={text('header', '')}>
      ...
      <CollectionItem secondaryContent={icon('send')}>Simon</CollectionItem>
      <CollectionItem secondaryContent={icon('send')}>Theodore</CollectionItem>
    </Collection>
  ))
